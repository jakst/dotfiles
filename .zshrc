...
alias t="turbo"
alias lu="linkup"
alias up="brew upgrade && brew upgrade --cask && proto upgrade && pnpm up -igL && bun update -g --latest && proto outdated --update --latest --yes --config-mode=global && proto use --config-mode=global"
